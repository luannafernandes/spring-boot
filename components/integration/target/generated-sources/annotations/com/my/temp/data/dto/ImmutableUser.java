...
public final class ImmutableUser implements User {
  ...
  private ImmutableUser(Integer userId, String name, String address) {
    this.userId = userId;
    this.name = name;
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link User#getUserId() userId} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for userId
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableUser withUserId(Integer value) {
    if (this.userId.equals(value)) return this;
    Integer newValue = Objects.requireNonNull(value, "userId");
    return new ImmutableUser(newValue, this.name, this.address);
  }
  ...
  public final ImmutableUser withName(String value) {
    ...
    return new ImmutableUser(this.userId, newValue, this.address);
  }

  /**
   * Copy the current immutable object by setting a value for the {@link User#getAddress() address} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for address
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableUser withAddress(String value) {
    if (this.address.equals(value)) return this;
    String newValue = Objects.requireNonNull(value, "address");
    return new ImmutableUser(this.userId, this.name, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code userId}, {@code name}, {@code address}.
  ...
  public static final class Builder {
    ...
    /**
     * Initializes the value for the {@link User#getUserId() userId} attribute.
    ...
    /**
     * Initializes the value for the {@link User#getAddress() address} attribute.
    ...
    public ImmutableUser build() {
      ...
      return new ImmutableUser(userId, name, address);
    }
